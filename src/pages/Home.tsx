      ...
      <section className="services-section">
        ...
        <div className="services-grid">
          ...
          <Link to="/servicios/SoporteMantenimiento" className="service-card">
            ...
            <p>
              Diagnosticamos y solucionamos fallas de hardware o software en tus
              equipos para que tu operación nunca se detenga.
            </p>
          ...
          <Link to="/servicios/DataCenter" className="service-card">
            ...
            <h3>Data Center</h3>
            <p>
              Infraestructura IT segura y económica. Ofrecemos espacio dedicado
              y protección de alto nivel para tus sistemas críticos.
            </p>
            <span className="service-link">Saber más →</span>
          </Link>
          ...
          <Link to="/servicios/Vps" className="service-card">
            ...
            <p>
              Servidores privados virtuales con la potencia y el control que tu
              negocio necesita para escalar con total flexibilidad.
            </p>
            <span className="service-link">Saber más →</span>
          </Link>
          ...
          <Link to="/servicios/DesarrolloSoftware" className="service-card">
            ...
            <p>
              Diseñamos soluciones digitales a medida que optimizan tus procesos
              internos y potencian tus resultados comerciales.
            </p>
            <span className="service-link">Saber más →</span>
          </Link>
            ...
            <div className="benefits-list">
              ...
              <div className="benefit-item">
                ...
                <div className="benefit-text">
                  ...
                  <p>
                    Con nosotros, puedes enfocarte en lo que realmente importa:
